...
**AAB actual:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.45, versionCode 46)
...
```yaml
version: 0.8.45+46   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ Play Console — conta aprovada · **teste fechado activo** · AAB **v0.8.45+46**  
