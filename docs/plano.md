...
**AAB actual:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.54, versionCode 55)
...
```yaml
version: 0.8.54+55   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ **v0.8.54** — Correcções: feed após load, inbox/slot prefs, transfer budget, self-transfer (versionCode 55)  
...
- ✅ Play Console — conta aprovada · **teste fechado activo** · AAB **v0.8.54+55**  
