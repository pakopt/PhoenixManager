...
**Upload:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.12, versionCode 13)
...
```yaml
version: 0.8.12+13   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ Play Console — conta aprovada; teste interno (AAB **v0.8.12+13** recomendado)  
