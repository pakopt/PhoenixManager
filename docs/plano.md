...
**Upload:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.8, versionCode 9)
...
```yaml
version: 0.8.8+9   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ Play Console — conta aprovada; teste interno (AAB **v0.8.8+9** recomendado)  
