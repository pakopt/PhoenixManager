...
**AAB actual:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.51, versionCode 52)
...
```yaml
version: 0.8.51+52   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ Play Console — conta aprovada · **teste fechado activo** · AAB **v0.8.51+52**  
