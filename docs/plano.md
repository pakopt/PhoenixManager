...
**Upload:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.11, versionCode 12)
...
```yaml
version: 0.8.11+12   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ Play Console — conta aprovada; teste interno (AAB **v0.8.11+12** recomendado)  
