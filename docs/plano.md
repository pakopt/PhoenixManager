...
**AAB actual:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.22, versionCode 23)
...
```yaml
version: 0.8.22+23   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ Play Console — conta aprovada · **teste fechado activo** · AAB **v0.8.22+23**  
...
- ✅ Polish UI v0.8.x — **congelado** em v0.8.17; v0.8.18–0.8.22 = onboarding/beta  
