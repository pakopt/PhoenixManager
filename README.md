...
**Versão actual:** `0.8.19+20` · AAB: `build/release/mobile/android/phoenix_manager.aab`  
**Bloqueio Play:** ≥12 testadores opted-in × 14 dias → candidatar produção ([`docs/STORE.md`](docs/STORE.md) §9c)

| Plataforma | Estado |
|------------|--------|
| Web (Chrome) | ✅ dev |
| **Android** (APK + AAB) | ✅ teste fechado Play · AAB v0.8.19 |
