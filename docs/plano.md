...
**AAB actual:** `build/release/mobile/android/phoenix_manager.aab` (v0.8.26, versionCode 27)
...
```yaml
version: 0.8.26+27   # nome visível + versionCode (obrigatório incrementar +N)
```
...
- ✅ Play Console — conta aprovada · **teste fechado activo** · AAB **v0.8.26+27**  
...
- ✅ Polish UI v0.8.x — **congelado** em v0.8.17; v0.8.18–0.8.26 = onboarding/beta / branding  
